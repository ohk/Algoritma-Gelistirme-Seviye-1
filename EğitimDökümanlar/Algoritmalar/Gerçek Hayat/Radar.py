...
for i in range(0,100,1):
    ...
    print("Durum",i+1)
    if haversine(lon1,lat1,merkezlon,merkezlat)>6500:
        ...
        print("Tespit edilen cismin kordinatları {},{}\nAramızdaki uzaklık: {}\nCismin uzaklığı tehdit boyutundadır. Acil durum olabilir.".format(lon1,lat1,haversine(lon1,lat1,merkezlon,merkezlat)))
    print("\n------------------------------------------------------------------------\n")
